...
<?php
/*
ADDRESS:	HTTP://WWW.GILMANNEWS.COM/ADMIN/ISSUECREATE.PHP
STATUS:		FINISHED
...
Create New Issue</h2></center>
<br>

<?php
//FIND MAX ID IN MASTER ISSUELIST TABLE TO FIND NEW ISSUE'S ID
...
<form action="issuecreateprocess.php" method="POST">

<b>Issue ID:</b> <?php echo $id; ?><br>
<input type="hidden" name="issueid" value="<?php echo $id;?>">
<i>Selected Automatically</i><br>
<br>

<b>Issue table:</b><input type="text" name="issuetable" size="20"><br>
<i>Each issue is given a MySQL table such as 2008marcharticles.  </i><br>
<br>

<b>Month:</b><input type="text" name="month" size="2"><br>
