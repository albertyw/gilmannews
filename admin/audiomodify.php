...
<?php
/*
ADDRESS:	HTTP://WWW.GILMANNEWS.COM/ADMIN/AUDIOMODIFY.PHP
STATUS:		FINISHED
LAST MODIFIED:	JUNE 4, 2008 BY ALBERT WANG '08
DESCRIPTION:	MODIFY AUDIO ENTRIES
USAGE:		PASSWORDED
*/
...
<form action="audiomodifyprocess.php" method="POST">
...
<b>File Location:</b> <i>(http://www.gilmannews.com/audio/seniorspeech/joeschmoe.flv)</i><br>
<input type="text" size="100" name="filelocation" value="<?php echo $row['filelocation']; ?>"><br><br>
